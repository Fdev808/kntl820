...
//Setting ke 2
const nobot = "628316341088"

// Setting Donasi
const gopay = "083168004414"
const ovo = "083168004413"
const dana = "083168004413"
const pulsa = "083811034750"
const pulsa2 = "0882-1329-2687"
const ig = "Shiki_kawai"
const github = "Satria356"
...
module.exports = async(conn, msg, m, setting, store) => {
    ...
    const readmore = more.repeat(4001)
		...
		const button5 = [
			...
			{ quickReplyButton: { displayText: `📝Menu List`, id: `${prefix}menu` } },
		]
		...
		if (isPlayGame(from, tekateki) && isUser) {
		  if (chats.toLowerCase() == getJawabanGame(from, tekateki)) {
			...
			{ quickReplyButton: { displayText: `Main Lagi`, id: `${prefix}tekateki` } },
			 ...
			 conn.sendMessage(from, { text: texttg, templateButtons: kus, footer: 'KUIS LAGI', mentions: [sender]} )  
		...
		if (isPlayGame(from, tebaktebakan) && isUser) {
		  if (chats.toLowerCase() == getJawabanGame(from, tebaktebakan)) {
			...
			{ quickReplyButton: { displayText: `Main Lagi`, id: `${prefix}kuis` } },
			 ...
			 conn.sendMessage(from, { text: texttg, templateButtons: kus, footer: 'quiz for fun', mentions: [sender]} )  
...
conn.sendMessage(from, { caption: teks, image: fs.readFileSync('media/Jojo2.jpg'), templateButtons: buttonsDefault, footer: 'Bot For Fun Masa-Bot', mentions: [sender]} )
				break
case prefix+'delete':
  case prefix+'d':
    case prefix+'del':
...
case prefix+'donasi':
  case prefix+'donate':
  var donasibut = [
			{ urlButton: { displayText: `Call Owner`, url : `wa.me/6283811034750` } },
			{ quickReplyButton: { displayText: `💸Donate`, id: `${prefix}donasiah` } },
		]
var teks = `  │
  •Dana/Gopay 083168004413
  •Pulsa 08311034750
  
  Donasi Untuk Upgrade Ke Fitur Premium
  Note : Donasi Seikhlasnya`
 conn.sendMessage(from, { caption: teks, image: {url: `https://telegra.ph/file/db89a801e300bdf753b2d.jpg`}, templateButtons: donasibut, footer: '© Bryan Fdev', mentions: [sender]} )  
			    break
case prefix+'sewa':
  case prefix+'daftarprem':
  var teks = `*[ Sewa and Premium ]*
...
*LIST SEWA*
- Rp.5.000 - PERMANENT`
			    conn.sendMessage(from, { caption: teks, location: { jpegThumbnail: fs.readFileSync('media/Jojo2.jpg') }, templateButtons: button5, footer: '© Bot for fun', mentions: [sender] })
			    break
			case prefix+'runtime':
...
case prefix+'infobot':
  case prefix+'inforobot':
    case prefix+'info':
      var caption = `*[ MASA BOT INFO ]*

*Nama Bot :* Masa
*Name Owner :* Bryan Fdev
*Engine :* NodeJs
*Status :* Aktif
  ...
  Note : Donasi Seikhlasnya`)
			...
			case prefix+'owner':
			    for (let x of ownerNumber) {
			      sendContact(from, x.split('6283811034750@s.whatsapp.net')[0], 'Fdev', msg)
			    }
			    /*conn.sendMessage(from, { audio: {url : `https://b.top4top.io/m_2223iin241.mp3`}, mimetype: 'audio/mp4', ptt: true}, {quoted: msg})*/
			    var owncuy = [
			{ quickReplyButton: { displayText: `📝Menu`, id: `${prefix}menu` } },
		]
		conn.sendMessage(from, {text: `Ingin bertanya tanya tentang apa?`, templateButtons: owncuy, footer: `My Name : Fdev`, mentions: [sender]} )
			    break
case prefix+'own':
 reply(`@6283811034750`)
 break
case prefix+'wm':
 reply(`wa.me/6283811034750`)
 break
			case prefix+'cekprem':
			...
			{ quickReplyButton: { displayText: `Ubah Ke Audio`, id: `${prefix}tiktokaudio ${q}` } },
				...
				reply(mess.wait)
				conn.sendMessage(from, { caption: `Succes Download Video Tiktok, Thanks For Using JOJO-BOT!`, video: {url: data.nowm}, templateButtons: tidtod, footer: 'Masa-Bot', mentions: [sender]} )
			}).catch(() => reply(mess.error.api))
			limitAdd(sender, limit)
			    break
...
conn.sendMessage(from, { text: slotnya, buttons: but, footer: "© Bot For Fun\nMasa - Bot", templateButtons: but }, {quoted: msg})
gameAdd(sender, glimit)
        break
case prefix+'cekme':
  case prefix+'me':
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  const ganteng = ['Cakep😍️','Jelek njir🐦']
  const sifat = ['Pembohong','Galak','Suka Bantu Orang','Baik','Jahat:(','Bobrok','Sering ngocok','Setia','Tulus','Beriman','Penyayang Binatang','Baperan']
...
conn.sendMessage(from, {caption: "© Bot For Fun", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/tiktok-effect?text=${args[1]}&text2=${args[2]}`}}, {quoted: msg})
limitAdd(sender, limit)
break
case prefix+'flaming':
  ...
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
conn.sendMessage(from, {caption: "© Bot For Fun", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/flaming-fire?text=${q}`}}, {quoted: msg})
limitAdd(sender, limit)
break
case prefix+'shadow':
  ...
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
conn.sendMessage(from, {caption: "© Bot For Fun", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/shadow-sky?text=${q}`}}, {quoted: msg})
limitAdd(sender, limit)
break
case prefix+'wolftext':
  ...
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
conn.sendMessage(from, {caption: "© Bot For Fun", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/wolf-metal?text=${q}`}}, {quoted: msg})
limitAdd(sender, limit)
break
case prefix+'cup':
  if (args.length < 2) return reply(`Kirim perintah ${command} <Text1>`)
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
conn.sendMessage(from, {caption: "© Bot For Fun", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/teks-cup?text=${q}`}}, {quoted: msg})
limitAdd(sender, limit)
break
case prefix+'romantic':
  ...
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
conn.sendMessage(from, {caption: "© Bot For Fun", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/romantic-messages?text=${q}`}}, {quoted: msg})
limitAdd(sender, limit)
break
case prefix+'writetext':
  ...
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
conn.sendMessage(from, {caption: "© Bot For Fun", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/burn-paper?text=${q}`}}, {quoted: msg})
limitAdd(sender, limit)
break
case prefix+'cup2':
  if (args.length < 2) return reply(`Kirim perintah ${command} <Text1>`)
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
conn.sendMessage(from, {caption: "© Bot For Fun", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/funny-cup?text=${q}`}}, {quoted: msg})
limitAdd(sender, limit)
break
case prefix+'lovetext':
  ...
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
conn.sendMessage(from, {caption: "© Bot For Fun", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/love-messages?text=${q}`}}, {quoted: msg})
limitAdd(sender, limit)
break
case prefix+'lovetext2':
  ...
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
conn.sendMessage(from, {caption: "© Bot For Fun", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/romantic-double?text=${q}`}}, {quoted: msg})
limitAdd(sender, limit)
break
case prefix+'undergrass':
  ...
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
conn.sendMessage(from, {caption: "© Bot For Fun", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/under-grass?text=${q}`}}, {quoted: msg})
limitAdd(sender, limit)
break
...
case prefix+'coffecup':
  ...
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
conn.sendMessage(from, {caption: "© Bot For Fun", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/coffee-cup?text=${q}`}}, {quoted: msg})
limitAdd(sender, limit)
break
...
conn.sendMessage(from, {caption: "© Bot For Fun", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/wood-hearth?text=${q}`}}, {quoted: msg})
limitAdd(sender, limit)
break
